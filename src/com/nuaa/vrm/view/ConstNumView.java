...
*
*/
public class ConstNumView extends ViewPart implements ISelectionListener{

	public static final String ID = "Variable-Relation-Model-Generate-Tool.ConstNumView";
...
//	private Label requireID ;
	...
	public void createPartControl(Composite parent) {
		...
		txt_describe.setBounds(120, 280, 500, 400);
		
		
		
		Button b1=new Button(top,SWT.PUSH);
		b1.setBounds(70, 750, 100, 26);
		b1.setText("确定");
		b1.addSelectionListener(new SelectionAdapter() 
		{
			public void widgetSelected(SelectionEvent e) {
				...
				output_string4 = txt_source.getText();		
				output_string5 = txt_describe.getText();
				...
				// 这里可以继续添加子节点，也可以指定内容
				rootElement.setText("这个是常量的文本信息");
				Element element = rootElement.addElement("view name");
				element.addAttribute("view name", "常量");
				...
				sourceElement.addAttribute("source", output_string4);
				describeElement.addAttribute("describe", output_string5);
				// 设置XML文档格式
				...
				try {
					...
					File file = new File("C:\\Users\\10182\\Desktop\\constNum.xml");
