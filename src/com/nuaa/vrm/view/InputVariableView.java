...
*
*/
public class InputVariableView extends ViewPart implements ISelectionListener{

	public static final String ID = "Variable-Relation-Model-Generate-Tool.InputVariableView";
	...
	public void createPartControl(Composite parent) {
		...
		b1.addSelectionListener(new SelectionAdapter() 
		{
			public void widgetSelected(SelectionEvent e) {
				...
				output_string6=	txt_source.getText();
				...
				// 这里可以继续添加子节点，也可以指定内容
				rootElement.setText("这个是输入变量的文本信息");
				Element element = rootElement.addElement("view name");
				element.addAttribute("view name", "输入变量");
				...
				Element contextElement = element.addElement("source");
				...
				contextElement.addAttribute("source", output_string6);
				...
				try {
					...
					File file = new File("C:\\Users\\10182\\Desktop\\inputVariable.xml");
