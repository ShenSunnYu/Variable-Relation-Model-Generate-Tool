...
*
*/
public class MiddleVariableView extends ViewPart implements ISelectionListener{

	public static final String ID = "Variable-Relation-Model-Generate-Tool.MiddleVariableView";
	...
	private Text  txt_context;//内容输入框
...
//	private Label requireID ;
	...
	public void createPartControl(Composite parent) {
		...
		lab_context = new Label(top, SWT.NONE);
		lab_context.setText("内容:");
		lab_context.setFont(boldFont);
		lab_context.setBounds(20, 340, 100, 60);
		
		txt_context = new Text(top, SWT.BORDER);
		txt_context.setFont(new Font(display,"宋体",16,SWT.NORMAL));
		txt_context.setBounds(120, 340, 500, 26);
		...
		b1.addSelectionListener(new SelectionAdapter() 
		{
			public void widgetSelected(SelectionEvent e) {
				...
				output_string6=	txt_context.getText();
				...
				// 这里可以继续添加子节点，也可以指定内容
				rootElement.setText("这个是中间变量的文本信息");
				Element element = rootElement.addElement("view name");
				element.addAttribute("view name", "中间变量");
				...
				Element contextElement = element.addElement("context");
				...
				contextElement.addAttribute("context", output_string6);
				...
				try {
					...
					File file = new File("C:\\Users\\10182\\Desktop\\middleVariable.xml");
