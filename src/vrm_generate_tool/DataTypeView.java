...
*
*/
public class DataTypeView extends ViewPart implements ISelectionListener{

	public static final String ID = "Variable-Relation-Model-Generate-Tool.DataTypeView";
	...
	private Combo co_type;//类型输入框
	private Text  txt_range;//值域输入框
...
/*		txt_type = new Text(top, SWT.BORDER);
	...
	*/	
		...
		co_type = new Combo(top, SWT.NONE);
		co_type.setFont(new Font(display,"宋体",12,SWT.NORMAL));
		co_type.add("Char");
		co_type.add("Boolean");
		co_type.add("Enumerated");
		co_type.add("Int");
		co_type.add("Double");
		co_type.add("Float");
		co_type.add("String");
		...
		b1.setBounds(70, 320, 100, 26);
		b1.setText("确定");
		b1.addSelectionListener(new SelectionAdapter() 
		{
			public void widgetSelected(SelectionEvent e) {
				output_string1 = txt_name.getText();
				output_string2 = co_type.getText();
				...
				// 这里可以继续添加子节点，也可以指定内容
				rootElement.setText("这个是数据类型的文本信息");
				Element element = rootElement.addElement("view name");
				element.addAttribute("view name", "数据类型");
				...
				try {
					...
					File file = new File("C:\\Users\\10182\\Desktop\\dataType.xml");
