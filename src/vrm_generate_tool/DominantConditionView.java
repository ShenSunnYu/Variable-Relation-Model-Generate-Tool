 ...
 *
 */
public class DominantConditionView extends ViewPart implements ISelectionListener{

	public static final String ID = "Variable-Relation-Model-Generate-Tool.DominantConditionView";
